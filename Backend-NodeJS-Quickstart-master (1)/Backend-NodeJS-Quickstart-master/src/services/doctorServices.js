...
// Save doctor markdown information
            ...
            if (!idInput) {
                ...
                let data = await db.Doctor_Infor.findOne({
                    ...
                    include: [
                        ...
                        { model: db.Allcode, as: 'provinceTypeData', attributes: ['valueEn'] },
                        { model: db.Allcode, as: 'paymentTypeData', attributes: ['valueEn'] }
                    ],
                    raw: false,
                    nest: true
                });
